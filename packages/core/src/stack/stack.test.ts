...
// AC1 (depth-N push, no loss), AC6 (non-destructive read underflow), AC7
// (non-mutating reads), AC8 (raw-double fidelity), AC9 (UI-free use), AC10 (no
// fixed ceiling). Operator application and dup/swap/drop are later work items.
